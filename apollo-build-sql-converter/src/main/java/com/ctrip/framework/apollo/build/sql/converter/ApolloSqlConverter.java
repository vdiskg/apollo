...
public class ApolloSqlConverter {
  ...
  public static List<String> convert(String targetParentDir) {
    ...
    // 'scripts/sql/src' -> 'scripts/sql/profiles/h2'
    convertH2List(templateList, srcDir, targetParentDir, gists);
  ...
  private static void convertH2List(List<SqlTemplate> templateList, String srcDir,
      String targetParentDir, SqlTemplateGist gists) {
    String targetDir = targetParentDir + "/scripts/sql/profiles/h2";
